...
<head>
    ...
    <link rel="stylesheet" href="{{asset('waitlist/admin/vendor/libs/apex-charts/apex-charts.css')}}" />
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                <div class="avatar avatar-online">
                                    <img src="https://ui-avatars.com/api/?name={{$user->name}}" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                            </a>
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                        <div class="mb-2 mb-md-0">
                            ...
                            , made with ❤️ by
                            <a href="{{url('/')}}" target="_blank" class="footer-link fw-medium">{{$siteName}}</a>
                        </div>
                    </div>
                </footer>
                <!-- / Footer -->
...
<!-- Vendors JS -->
<script src="{{asset('waitlist/admin/vendor/libs/apex-charts/apexcharts.js')}}"></script>

<!-- Main JS -->
<script src="{{asset('waitlist/admin/js/main.js')}}"></script>

<!-- Page JS -->
<script src="{{asset('waitlist/admin/js/dashboards-analytics.js')}}"></script>
